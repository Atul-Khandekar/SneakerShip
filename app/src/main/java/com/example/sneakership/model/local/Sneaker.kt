...
data class Sneaker(
    ...
    companion object {
        fun getSneakers(): List<Sneaker> {
            ...
            return listOf(
                Sneaker(
                    UUID.randomUUID(), "Red Tape", Gender.MALE, listOf(
                ...
                Sneaker(
                    UUID.randomUUID(), "Asian", Gender.MALE, listOf(
                ...
                Sneaker(
                    UUID.randomUUID(), "Bacca Bucci", Gender.MALE, listOf(
                ...
                Sneaker(
                    UUID.randomUUID(), "U.S POLO ", Gender.MALE, listOf(
                ...
                Sneaker(
                    UUID.randomUUID(), "NIKE", Gender.MALE, listOf(
                ...
                Sneaker(
                    UUID.randomUUID(), "NIKE", Gender.FEMALE, listOf(
                ...
                Sneaker(
                    UUID.randomUUID(), "ADIDAS", Gender.FEMALE, listOf(
